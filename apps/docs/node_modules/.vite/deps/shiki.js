...
function resolveParsedThemeRules(parsedThemeRules, _colorMap) {
  parsedThemeRules.sort((a, b3) => {
    let r4 = strcmp(a.scope, b3.scope);
    if (r4 !== 0) {
      return r4;
    }
    r4 = strArrCmp(a.parentScopes, b3.parentScopes);
    if (r4 !== 0) {
      return r4;
    }
...
var ThemeTrieElement = class _ThemeTrieElement {
  ...
  static _cmpBySpecificity(a, b3) {
    if (a.scopeDepth !== b3.scopeDepth) {
      return b3.scopeDepth - a.scopeDepth;
    }
    let aParentIndex = 0;
    let bParentIndex = 0;
    while (true) {
      ...
      if (aParentIndex >= a.parentScopes.length || bParentIndex >= b3.parentScopes.length) {
        break;
      }
      const parentScopeLengthDiff = b3.parentScopes[bParentIndex].length - a.parentScopes[aParentIndex].length;
    ...
    return b3.parentScopes.length - a.parentScopes.length;
  }
  match(scope) {
    if (scope !== "") {
...
var AttributedScopeStack = class _AttributedScopeStack {
  ...
  static equals(a, b3) {
    do {
      ...
      if (a.scopeName !== b3.scopeName || a.tokenAttributes !== b3.tokenAttributes) {
        return false;
      }
      a = a.parent;
      b3 = b3.parent;
...
var StateStackImpl = (_a2 = class {
  ...
  static _equals(a, b3) {
    ...
    if (!this._structuralEquals(a, b3)) {
      return false;
    }
    return AttributedScopeStack.equals(a.contentNameScopesList, b3.contentNameScopesList);
  }
  /**
   * A structural equals check. Does not take into account `scopes`.
   */
  static _structuralEquals(a, b3) {
    do {
      if (a === b3) {
        return true;
      }
      ...
      if (a.depth !== b3.depth || a.ruleId !== b3.ruleId || a.endRule !== b3.endRule) {
        return false;
      }
      a = a.parent;
      b3 = b3.parent;
...
function serializeAttribute(state, key2, value) {
  ...
  if (state.settings.preferUnquoted) {
    result = stringifyEntities(
      ...
      Object.assign({}, state.settings.characterReferences, {
        attribute: true,
        subset: constants.unquoted[x3][y2]
      })
    );
  }
  if (result !== value) {
    ...
    result = quote + stringifyEntities(
      ...
      Object.assign({}, state.settings.characterReferences, {
        // Always encode without parse errors in non-HTML.
        subset: (quote === "'" ? constants.single : constants.double)[x3][y2],
        attribute: true
      })
    ) + quote;
  }
...
// node_modules/.pnpm/@shikijs+core@3.2.1/node_modules/@shikijs/core/dist/index.mjs
...
function splitTokens(tokens, breakpoints) {
  const sorted = Array.from(breakpoints instanceof Set ? breakpoints : new Set(breakpoints)).sort((a, b3) => a - b3);
  if (!sorted.length)
    return tokens;
  return tokens.map((line) => {
    return line.flatMap((token2) => {
      const breakpointsInToken = sorted.filter((i2) => token2.offset < i2 && i2 < token2.offset + token2.content.length).map((i2) => i2 - token2.offset).sort((a, b3) => a - b3);
...
function transformerDecorations() {
  ...
  return {
    ...
    code(codeEl) {
      ...
      const lineApplies = [];
      const sorted = ctx.decorations.sort((a, b3) => b3.start.offset - a.start.offset || a.end.offset - b3.end.offset);
    ...
    for (let r4 = 0; r4 < 6; r4++) {
      for (let g2 = 0; g2 < 6; g2++) {
        for (let b3 = 0; b3 < 6; b3++) {
          colorTable.push(rgbColor([levels[r4], levels[g2], levels[b3]]));
        }
      }
    }
    let level = 8;
...
function dimColor(color) {
  ...
  if (hexMatch) {
    if (hexMatch[3]) {
      ...
      return `#${Array.from(hexMatch[1]).map((x3) => `${x3}${x3}`).join("")}80`;
    }
  }
...
function codeToTokensWithThemes(internal, code, options) {
  ...
  const mergedGrammarState = themedTokens[0].state ? new GrammarState(
    Object.fromEntries(themedTokens.map((s4) => {
      var _a4;
      return [s4.theme, (_a4 = s4.state) == null ? void 0 : _a4.getInternalStack(s4.theme)];
    })),
...
function codeToTokens(internal, code, options) {
  ...
  if ("themes" in options) {
    ...
    const themes = Object.entries(options.themes).filter((i2) => i2[1]).map((i2) => ({ color: i2[0], theme: i2[1] })).sort((a, b3) => a.color === defaultColor ? -1 : b3.color === defaultColor ? 1 : 0);
    if (themes.length === 0)
  ...
  loadLanguage(lang) {
    ...
    if (embeddedLazilyBy.size) {
      for (const e2 of embeddedLazilyBy) {
        ...
        this._loadedLanguagesCache = null;
        (_b = (_a4 = this._syncRegistry) == null ? void 0 : _a4._injectionGrammars) == null ? void 0 : _b.delete(e2.scopeName);
        (_d = (_c = this._syncRegistry) == null ? void 0 : _c._grammars) == null ? void 0 : _d.delete(e2.scopeName);
...
function makeSingletonHighlighterCore(createHighlighter2) {
  ...
  async function getSingletonHighlighterCore2(options) {
    if (!_shiki) {
      ...
      const s4 = await _shiki;
      await Promise.all([
        s4.loadTheme(...options.themes || []),
        s4.loadLanguage(...options.langs || [])
      ]);
      return s4;
    }
  }
...
// node_modules/.pnpm/shiki@3.2.1/node_modules/shiki/dist/langs.mjs
var bundledLanguagesInfo = [
  {
    "id": "abap",
    "name": "ABAP",
    "import": () => import("./abap-D4I2WRKH.js")
  },
  {
    "id": "actionscript-3",
    "name": "ActionScript",
    "import": () => import("./actionscript-3-FUGZQ2NU.js")
  },
  {
    "id": "ada",
    "name": "Ada",
    "import": () => import("./ada-PR6VKC6N.js")
  },
  {
    "id": "angular-html",
    "name": "Angular HTML",
    "import": () => import("./angular-html-CPV2ZI4C.js")
  },
  {
    "id": "angular-ts",
    "name": "Angular TypeScript",
    "import": () => import("./angular-ts-AJYPGN54.js")
  },
  {
    "id": "apache",
    "name": "Apache Conf",
    "import": () => import("./apache-KXXAAKFH.js")
  },
  {
    "id": "apex",
    "name": "Apex",
    "import": () => import("./apex-2WDCYM75.js")
  },
  {
    "id": "apl",
    "name": "APL",
    "import": () => import("./apl-4BARJPVW.js")
  },
  {
    "id": "applescript",
    "name": "AppleScript",
    "import": () => import("./applescript-NDOUGTWD.js")
  },
  {
    "id": "ara",
    "name": "Ara",
    "import": () => import("./ara-4CYIYUO3.js")
  },
  {
    "id": "asciidoc",
    "name": "AsciiDoc",
    ...
    "import": () => import("./asciidoc-SUE3DT64.js")
  },
  {
    "id": "asm",
    "name": "Assembly",
    "import": () => import("./asm-JMH4Z2NP.js")
  },
  {
    "id": "astro",
    "name": "Astro",
    "import": () => import("./astro-JECT25L6.js")
  },
  {
    "id": "awk",
    "name": "AWK",
    "import": () => import("./awk-NRV5VKKC.js")
  },
  {
    "id": "ballerina",
    "name": "Ballerina",
    "import": () => import("./ballerina-A6SB6OTH.js")
  },
  {
    "id": "bat",
    "name": "Batch File",
    ...
    "import": () => import("./bat-FYXHIBJV.js")
  },
  {
    "id": "beancount",
    "name": "Beancount",
    "import": () => import("./beancount-KRNYK6WZ.js")
  },
  {
    "id": "berry",
    "name": "Berry",
    ...
    "import": () => import("./berry-LBIUQLPU.js")
  },
  {
    "id": "bibtex",
    "name": "BibTeX",
    "import": () => import("./bibtex-2ZWGOMLR.js")
  },
  {
    "id": "bicep",
    "name": "Bicep",
    "import": () => import("./bicep-OIG6Y52P.js")
  },
  {
    "id": "blade",
    "name": "Blade",
    "import": () => import("./blade-QQPZM3KN.js")
  },
  {
    "id": "bsl",
    "name": "1C (Enterprise)",
    ...
    "import": () => import("./bsl-L5OXDYLE.js")
  },
  {
    "id": "c",
    "name": "C",
    "import": () => import("./c-ZRTOJSU6.js")
  },
  {
    "id": "cadence",
    "name": "Cadence",
    ...
    "import": () => import("./cadence-5ZNWENBO.js")
  },
  {
    "id": "cairo",
    "name": "Cairo",
    "import": () => import("./cairo-ONROIGWK.js")
  },
  {
    "id": "clarity",
    "name": "Clarity",
    "import": () => import("./clarity-U4RWXB4K.js")
  },
  {
    "id": "clojure",
    "name": "Clojure",
    ...
    "import": () => import("./clojure-OOKLNIZM.js")
  },
  {
    "id": "cmake",
    "name": "CMake",
    "import": () => import("./cmake-XH6UNWKU.js")
  },
  {
    "id": "cobol",
    "name": "COBOL",
    "import": () => import("./cobol-K2QX5OVO.js")
  },
  {
    "id": "codeowners",
    "name": "CODEOWNERS",
    "import": () => import("./codeowners-3FHOWJCR.js")
  },
  {
    "id": "codeql",
    "name": "CodeQL",
    ...
    "import": () => import("./codeql-NH7IHFVM.js")
  },
  {
    "id": "coffee",
    "name": "CoffeeScript",
    ...
    "import": () => import("./coffee-WPMG63OP.js")
  },
  {
    "id": "common-lisp",
    "name": "Common Lisp",
    ...
    "import": () => import("./common-lisp-XI6ZUBBN.js")
  },
  {
    "id": "coq",
    "name": "Coq",
    "import": () => import("./coq-VIE47EMX.js")
  },
  {
    "id": "cpp",
    "name": "C++",
    ...
    "import": () => import("./cpp-JL2WYTO2.js")
  },
  {
    "id": "crystal",
    "name": "Crystal",
    "import": () => import("./crystal-R2UDQP2N.js")
  },
  {
    "id": "csharp",
    "name": "C#",
    ...
    "import": () => import("./csharp-PXC57VJ2.js")
  },
  {
    "id": "css",
    "name": "CSS",
    "import": () => import("./css-N75KO3SN.js")
  },
  {
    "id": "csv",
    "name": "CSV",
    "import": () => import("./csv-ESA3AUIR.js")
  },
  {
    "id": "cue",
    "name": "CUE",
    "import": () => import("./cue-SYOKGULG.js")
  },
  {
    "id": "cypher",
    "name": "Cypher",
    ...
    "import": () => import("./cypher-FYEKNKQZ.js")
  },
  {
    "id": "d",
    "name": "D",
    "import": () => import("./d-L4DUKGJP.js")
  },
  {
    "id": "dart",
    "name": "Dart",
    "import": () => import("./dart-MTRMYQDL.js")
  },
  {
    "id": "dax",
    "name": "DAX",
    "import": () => import("./dax-7MTGXPWA.js")
  },
  {
    "id": "desktop",
    "name": "Desktop",
    "import": () => import("./desktop-LSA2NLG4.js")
  },
  {
    "id": "diff",
    "name": "Diff",
    "import": () => import("./diff-LPLKHAP3.js")
  },
  {
    "id": "docker",
    "name": "Dockerfile",
    ...
    "import": () => import("./docker-PIHN7NQV.js")
  },
  {
    "id": "dotenv",
    "name": "dotEnv",
    "import": () => import("./dotenv-I4A6ZOPR.js")
  },
  {
    "id": "dream-maker",
    "name": "Dream Maker",
    "import": () => import("./dream-maker-UD3EBDEW.js")
  },
  {
    "id": "edge",
    "name": "Edge",
    "import": () => import("./edge-6EK73WNW.js")
  },
  {
    "id": "elixir",
    "name": "Elixir",
    "import": () => import("./elixir-Z5OE6JA2.js")
  },
  {
    "id": "elm",
    "name": "Elm",
    "import": () => import("./elm-OYM6KQPH.js")
  },
  {
    "id": "emacs-lisp",
    "name": "Emacs Lisp",
    ...
    "import": () => import("./emacs-lisp-GMIFXMUY.js")
  },
  {
    "id": "erb",
    "name": "ERB",
    "import": () => import("./erb-KHOPNUSC.js")
  },
  {
    "id": "erlang",
    "name": "Erlang",
    ...
    "import": () => import("./erlang-2VGJCWT5.js")
  },
  {
    "id": "fennel",
    "name": "Fennel",
    "import": () => import("./fennel-WBHAIQLI.js")
  },
  {
    "id": "fish",
    "name": "Fish",
    "import": () => import("./fish-DX4G2AGA.js")
  },
  {
    "id": "fluent",
    "name": "Fluent",
    ...
    "import": () => import("./fluent-RSCU6J3N.js")
  },
  {
    ...
    "import": () => import("./fortran-fixed-form-IDW5T4IJ.js")
  },
  {
    ...
    "import": () => import("./fortran-free-form-PGE3OKI6.js")
  },
  {
    "id": "fsharp",
    "name": "F#",
    ...
    "import": () => import("./fsharp-PFIHNELH.js")
  },
  {
    "id": "gdresource",
    "name": "GDResource",
    "import": () => import("./gdresource-ZRSN7NCU.js")
  },
  {
    "id": "gdscript",
    "name": "GDScript",
    "import": () => import("./gdscript-D7ID3XOC.js")
  },
  {
    "id": "gdshader",
    "name": "GDShader",
    "import": () => import("./gdshader-XCDNAR2J.js")
  },
  {
    "id": "genie",
    "name": "Genie",
    "import": () => import("./genie-RCY7RKR4.js")
  },
  {
    "id": "gherkin",
    "name": "Gherkin",
    "import": () => import("./gherkin-UEAFHLLX.js")
  },
  {
    "id": "git-commit",
    "name": "Git Commit Message",
    "import": () => import("./git-commit-AC3O6VJL.js")
  },
  {
    "id": "git-rebase",
    "name": "Git Rebase Message",
    "import": () => import("./git-rebase-GGSPUTOD.js")
  },
  {
    "id": "gleam",
    "name": "Gleam",
    "import": () => import("./gleam-JETESSYN.js")
  },
  {
    "id": "glimmer-js",
    "name": "Glimmer JS",
    ...
    "import": () => import("./glimmer-js-UEFK6ANI.js")
  },
  {
    "id": "glimmer-ts",
    "name": "Glimmer TS",
    ...
    "import": () => import("./glimmer-ts-GI54RIGE.js")
  },
  {
    "id": "glsl",
    "name": "GLSL",
    "import": () => import("./glsl-3WYS6YYG.js")
  },
  {
    "id": "gnuplot",
    "name": "Gnuplot",
    "import": () => import("./gnuplot-NKJNDREL.js")
  },
  {
    "id": "go",
    "name": "Go",
    "import": () => import("./go-ZEGCGP45.js")
  },
  {
    "id": "graphql",
    "name": "GraphQL",
    ...
    "import": () => import("./graphql-A5AUVHZB.js")
  },
  {
    "id": "groovy",
    "name": "Groovy",
    "import": () => import("./groovy-EXY4U33N.js")
  },
  {
    "id": "hack",
    "name": "Hack",
    "import": () => import("./hack-C3O34NKK.js")
  },
  {
    "id": "haml",
    "name": "Ruby Haml",
    "import": () => import("./haml-DHB4AQWW.js")
  },
  {
    "id": "handlebars",
    "name": "Handlebars",
    ...
    "import": () => import("./handlebars-SPGWNAC4.js")
  },
  {
    "id": "haskell",
    "name": "Haskell",
    ...
    "import": () => import("./haskell-R4KVPKWD.js")
  },
  {
    "id": "haxe",
    "name": "Haxe",
    "import": () => import("./haxe-L2U3K4KG.js")
  },
  {
    "id": "hcl",
    "name": "HashiCorp HCL",
    "import": () => import("./hcl-W2MASAFP.js")
  },
  {
    "id": "hjson",
    "name": "Hjson",
    "import": () => import("./hjson-IDRQDTNR.js")
  },
  {
    "id": "hlsl",
    "name": "HLSL",
    "import": () => import("./hlsl-ZUFT4AGN.js")
  },
  {
    "id": "html",
    "name": "HTML",
    "import": () => import("./html-VWKNMBVW.js")
  },
  {
    "id": "html-derivative",
    "name": "HTML (Derivative)",
    "import": () => import("./html-derivative-WASJACLI.js")
  },
  {
    "id": "http",
    "name": "HTTP",
    "import": () => import("./http-KE7FCL22.js")
  },
  {
    "id": "hxml",
    "name": "HXML",
    "import": () => import("./hxml-H25SBD6I.js")
  },
  {
    "id": "hy",
    "name": "Hy",
    "import": () => import("./hy-355DBWGV.js")
  },
  {
    "id": "imba",
    "name": "Imba",
    "import": () => import("./imba-3UEYSXLR.js")
  },
  {
    "id": "ini",
    "name": "INI",
    ...
    "import": () => import("./ini-FGE42DDP.js")
  },
  {
    "id": "java",
    "name": "Java",
    "import": () => import("./java-OM2SW3FX.js")
  },
  {
    "id": "javascript",
    "name": "JavaScript",
    ...
    "import": () => import("./javascript-4EBKC6SN.js")
  },
  {
    "id": "jinja",
    "name": "Jinja",
    "import": () => import("./jinja-YGPNDZ5M.js")
  },
  {
    "id": "jison",
    "name": "Jison",
    "import": () => import("./jison-KAGC5RDG.js")
  },
  {
    "id": "json",
    "name": "JSON",
    "import": () => import("./json-JDB66GTO.js")
  },
  {
    "id": "json5",
    "name": "JSON5",
    "import": () => import("./json5-J4FSMPDA.js")
  },
  {
    "id": "jsonc",
    "name": "JSON with Comments",
    "import": () => import("./jsonc-3RWU6VOA.js")
  },
  {
    "id": "jsonl",
    "name": "JSON Lines",
    "import": () => import("./jsonl-3WB4LIUG.js")
  },
  {
    "id": "jsonnet",
    "name": "Jsonnet",
    "import": () => import("./jsonnet-V26J25ZA.js")
  },
  {
    "id": "jssm",
    "name": "JSSM",
    ...
    "import": () => import("./jssm-VWPN7DQ3.js")
  },
  {
    "id": "jsx",
    "name": "JSX",
    "import": () => import("./jsx-IQSKX3A7.js")
  },
  {
    "id": "julia",
    "name": "Julia",
    ...
    "import": () => import("./julia-TZ5MEN63.js")
  },
  {
    "id": "kotlin",
    "name": "Kotlin",
    ...
    "import": () => import("./kotlin-JNYFBWKX.js")
  },
  {
    "id": "kusto",
    "name": "Kusto",
    ...
    "import": () => import("./kusto-DIG54WGK.js")
  },
  {
    "id": "latex",
    "name": "LaTeX",
    "import": () => import("./latex-TNE4B5FG.js")
  },
  {
    "id": "lean",
    "name": "Lean 4",
    ...
    "import": () => import("./lean-UNJMV6QQ.js")
  },
  {
    "id": "less",
    "name": "Less",
    "import": () => import("./less-WHC36BN2.js")
  },
  {
    "id": "liquid",
    "name": "Liquid",
    "import": () => import("./liquid-SO7E746P.js")
  },
  {
    "id": "llvm",
    "name": "LLVM IR",
    "import": () => import("./llvm-ZH3YUGKJ.js")
  },
  {
    "id": "log",
    "name": "Log file",
    "import": () => import("./log-SAFIGYAY.js")
  },
  {
    "id": "logo",
    "name": "Logo",
    "import": () => import("./logo-NMESCDOA.js")
  },
  {
    "id": "lua",
    "name": "Lua",
    "import": () => import("./lua-4D775BAB.js")
  },
  {
    "id": "luau",
    "name": "Luau",
    "import": () => import("./luau-4IDEGHMO.js")
  },
  {
    "id": "make",
    "name": "Makefile",
    ...
    "import": () => import("./make-AH6UZ3U5.js")
  },
  {
    "id": "markdown",
    "name": "Markdown",
    ...
    "import": () => import("./markdown-RXY5GMHR.js")
  },
  {
    "id": "marko",
    "name": "Marko",
    "import": () => import("./marko-QAW32WN5.js")
  },
  {
    "id": "matlab",
    "name": "MATLAB",
    "import": () => import("./matlab-5HOHB3PT.js")
  },
  {
    "id": "mdc",
    "name": "MDC",
    "import": () => import("./mdc-GUPFSQ22.js")
  },
  {
    "id": "mdx",
    "name": "MDX",
    "import": () => import("./mdx-TGJ36JNS.js")
  },
  {
    "id": "mermaid",
    "name": "Mermaid",
    ...
    "import": () => import("./mermaid-JRP7BJZN.js")
  },
  {
    "id": "mipsasm",
    "name": "MIPS Assembly",
    ...
    "import": () => import("./mipsasm-Q2FSQS35.js")
  },
  {
    "id": "mojo",
    "name": "Mojo",
    "import": () => import("./mojo-UNWRXZ6R.js")
  },
  {
    "id": "move",
    "name": "Move",
    "import": () => import("./move-4WCPB2BD.js")
  },
  {
    "id": "narrat",
    ...
    "import": () => import("./narrat-SK5XVP6D.js")
  },
  {
    "id": "nextflow",
    "name": "Nextflow",
    ...
    "import": () => import("./nextflow-OTQ4I46R.js")
  },
  {
    "id": "nginx",
    "name": "Nginx",
    "import": () => import("./nginx-3G6ACGYD.js")
  },
  {
    "id": "nim",
    "name": "Nim",
    "import": () => import("./nim-XGWSWGZR.js")
  },
  {
    "id": "nix",
    "name": "Nix",
    "import": () => import("./nix-PCCXB72G.js")
  },
  {
    "id": "nushell",
    "name": "nushell",
    ...
    "import": () => import("./nushell-M6J3JMDI.js")
  },
  {
    "id": "objective-c",
    "name": "Objective-C",
    ...
    "import": () => import("./objective-c-QFOIO453.js")
  },
  {
    "id": "objective-cpp",
    "name": "Objective-C++",
    "import": () => import("./objective-cpp-Z5VRCTNX.js")
  },
  {
    "id": "ocaml",
    "name": "OCaml",
    "import": () => import("./ocaml-2VDONBNS.js")
  },
  {
    "id": "pascal",
    "name": "Pascal",
    "import": () => import("./pascal-SXI4QAST.js")
  },
  {
    "id": "perl",
    "name": "Perl",
    "import": () => import("./perl-4QLPOHSE.js")
  },
  {
    "id": "php",
    "name": "PHP",
    "import": () => import("./php-CADL5TP6.js")
  },
  {
    "id": "plsql",
    "name": "PL/SQL",
    "import": () => import("./plsql-LW3FKAPD.js")
  },
  {
    "id": "po",
    "name": "Gettext PO",
    ...
    "import": () => import("./po-PKFWIDVN.js")
  },
  {
    "id": "polar",
    "name": "Polar",
    "import": () => import("./polar-LSILHKQZ.js")
  },
  {
    "id": "postcss",
    "name": "PostCSS",
    "import": () => import("./postcss-UFCU6CQJ.js")
  },
  {
    "id": "powerquery",
    "name": "PowerQuery",
    "import": () => import("./powerquery-JMQN4JOU.js")
  },
  {
    "id": "powershell",
    "name": "PowerShell",
    ...
    "import": () => import("./powershell-JJA2HF7R.js")
  },
  {
    "id": "prisma",
    "name": "Prisma",
    "import": () => import("./prisma-SQB6CVFM.js")
  },
  {
    "id": "prolog",
    "name": "Prolog",
    "import": () => import("./prolog-7Q6VCXLM.js")
  },
  {
    "id": "proto",
    ...
    "import": () => import("./proto-4UOLG5Y2.js")
  },
  {
    "id": "pug",
    "name": "Pug",
    ...
    "import": () => import("./pug-ZIPR2GN5.js")
  },
  {
    "id": "puppet",
    "name": "Puppet",
    "import": () => import("./puppet-LJF3QGOD.js")
  },
  {
    "id": "purescript",
    "name": "PureScript",
    "import": () => import("./purescript-NOTDEVIE.js")
  },
  {
    "id": "python",
    "name": "Python",
    ...
    "import": () => import("./python-HWTDE5MJ.js")
  },
  {
    "id": "qml",
    "name": "QML",
    "import": () => import("./qml-U6OD6NYQ.js")
  },
  {
    "id": "qmldir",
    "name": "QML Directory",
    "import": () => import("./qmldir-CTTKIGXN.js")
  },
  {
    "id": "qss",
    "name": "Qt Style Sheets",
    "import": () => import("./qss-PYYELHFB.js")
  },
  {
    "id": "r",
    "name": "R",
    "import": () => import("./r-INO2IHY4.js")
  },
  {
    "id": "racket",
    "name": "Racket",
    "import": () => import("./racket-MYQXXYIW.js")
  },
  {
    "id": "raku",
    "name": "Raku",
    ...
    "import": () => import("./raku-JZSK5BWV.js")
  },
  {
    "id": "razor",
    "name": "ASP.NET Razor",
    "import": () => import("./razor-TKGZ44C2.js")
  },
  {
    "id": "reg",
    "name": "Windows Registry Script",
    "import": () => import("./reg-VRJUNXYU.js")
  },
  {
    "id": "regexp",
    "name": "RegExp",
    ...
    "import": () => import("./regexp-HUKBID76.js")
  },
  {
    "id": "rel",
    "name": "Rel",
    "import": () => import("./rel-SSMFUB75.js")
  },
  {
    "id": "riscv",
    "name": "RISC-V",
    "import": () => import("./riscv-M25LSTMB.js")
  },
  {
    "id": "rst",
    "name": "reStructuredText",
    "import": () => import("./rst-44DJFDRJ.js")
  },
  {
    "id": "ruby",
    "name": "Ruby",
    ...
    "import": () => import("./ruby-CV5RUCSM.js")
  },
  {
    "id": "rust",
    "name": "Rust",
    ...
    "import": () => import("./rust-TJLFWPX5.js")
  },
  {
    "id": "sas",
    "name": "SAS",
    "import": () => import("./sas-KC5Q2GY3.js")
  },
  {
    "id": "sass",
    "name": "Sass",
    "import": () => import("./sass-4GL3B6YU.js")
  },
  {
    "id": "scala",
    "name": "Scala",
    "import": () => import("./scala-LSY3VEYF.js")
  },
  {
    "id": "scheme",
    "name": "Scheme",
    "import": () => import("./scheme-4J4HRLV4.js")
  },
  {
    "id": "scss",
    "name": "SCSS",
    "import": () => import("./scss-V6Y65GDG.js")
  },
  {
    "id": "sdbl",
    "name": "1C (Query)",
    ...
    "import": () => import("./sdbl-VHZTQAU5.js")
  },
  {
    "id": "shaderlab",
    "name": "ShaderLab",
    ...
    "import": () => import("./shaderlab-EK3IB4FW.js")
  },
  {
    "id": "shellscript",
    "name": "Shell",
    ...
    "import": () => import("./shellscript-RZVUSFRZ.js")
  },
  {
    "id": "shellsession",
    "name": "Shell Session",
    ...
    "import": () => import("./shellsession-P7RXL5FH.js")
  },
  {
    "id": "smalltalk",
    "name": "Smalltalk",
    "import": () => import("./smalltalk-WKTLGGFC.js")
  },
  {
    "id": "solidity",
    "name": "Solidity",
    "import": () => import("./solidity-5ADBLIVJ.js")
  },
  {
    "id": "soy",
    ...
    "import": () => import("./soy-PSYLQCPP.js")
  },
  {
    "id": "sparql",
    "name": "SPARQL",
    "import": () => import("./sparql-5ATYNOI5.js")
  },
  {
    "id": "splunk",
    ...
    "import": () => import("./splunk-VAMSUSDY.js")
  },
  {
    "id": "sql",
    "name": "SQL",
    "import": () => import("./sql-QXFPERA6.js")
  },
  {
    "id": "ssh-config",
    "name": "SSH Config",
    "import": () => import("./ssh-config-ZLZBNTEU.js")
  },
  {
    "id": "stata",
    "name": "Stata",
    "import": () => import("./stata-ERP7UZ63.js")
  },
  {
    "id": "stylus",
    "name": "Stylus",
    ...
    "import": () => import("./stylus-J7WRO4RW.js")
  },
  {
    "id": "svelte",
    "name": "Svelte",
    "import": () => import("./svelte-O75CWWHV.js")
  },
  {
    "id": "swift",
    "name": "Swift",
    "import": () => import("./swift-PLP2YYLZ.js")
  },
  {
    "id": "system-verilog",
    "name": "SystemVerilog",
    "import": () => import("./system-verilog-YOLPBBRR.js")
  },
  {
    "id": "systemd",
    "name": "Systemd Units",
    "import": () => import("./systemd-OU4EHSSE.js")
  },
  {
    "id": "talonscript",
    "name": "TalonScript",
    ...
    "import": () => import("./talonscript-WLHIZ3MP.js")
  },
  {
    "id": "tasl",
    "name": "Tasl",
    "import": () => import("./tasl-GY4BO4TC.js")
  },
  {
    "id": "tcl",
    "name": "Tcl",
    "import": () => import("./tcl-PLD7P2RW.js")
  },
  {
    "id": "templ",
    "name": "Templ",
    "import": () => import("./templ-7WH6ZL2U.js")
  },
  {
    "id": "terraform",
    "name": "Terraform",
    ...
    "import": () => import("./terraform-V5VDHARN.js")
  },
  {
    "id": "tex",
    "name": "TeX",
    "import": () => import("./tex-URAPG7FJ.js")
  },
  {
    "id": "toml",
    "name": "TOML",
    "import": () => import("./toml-DFS3LDRI.js")
  },
  {
    "id": "ts-tags",
    ...
    "import": () => import("./ts-tags-7OLBIXEB.js")
  },
  {
    "id": "tsv",
    "name": "TSV",
    "import": () => import("./tsv-HM3FBZ2I.js")
  },
  {
    "id": "tsx",
    "name": "TSX",
    "import": () => import("./tsx-YSYBNJHB.js")
  },
  {
    "id": "turtle",
    "name": "Turtle",
    "import": () => import("./turtle-NIMFAPH3.js")
  },
  {
    "id": "twig",
    "name": "Twig",
    "import": () => import("./twig-G3PPSWPA.js")
  },
  {
    "id": "typescript",
    "name": "TypeScript",
    ...
    "import": () => import("./typescript-XS4ACK3B.js")
  },
  {
    "id": "typespec",
    "name": "TypeSpec",
    ...
    "import": () => import("./typespec-45JI4VHM.js")
  },
  {
    "id": "typst",
    "name": "Typst",
    ...
    "import": () => import("./typst-VQ37D6HY.js")
  },
  {
    "id": "v",
    "name": "V",
    "import": () => import("./v-6OK5JECJ.js")
  },
  {
    "id": "vala",
    "name": "Vala",
    "import": () => import("./vala-JXNQUCI4.js")
  },
  {
    "id": "vb",
    "name": "Visual Basic",
    ...
    "import": () => import("./vb-J3LO7BH3.js")
  },
  {
    "id": "verilog",
    "name": "Verilog",
    "import": () => import("./verilog-Q4DIQEBM.js")
  },
  {
    "id": "vhdl",
    "name": "VHDL",
    "import": () => import("./vhdl-XZYL2C5W.js")
  },
  {
    "id": "viml",
    "name": "Vim Script",
    ...
    "import": () => import("./viml-PHQUFZ3F.js")
  },
  {
    "id": "vue",
    "name": "Vue",
    "import": () => import("./vue-DO33H6C6.js")
  },
  {
    "id": "vue-html",
    "name": "Vue HTML",
    "import": () => import("./vue-html-QJFMB3XL.js")
  },
  {
    "id": "vyper",
    "name": "Vyper",
    ...
    "import": () => import("./vyper-A3PYJ53N.js")
  },
  {
    "id": "wasm",
    "name": "WebAssembly",
    "import": () => import("./wasm-SU4JFGZ5.js")
  },
  {
    "id": "wenyan",
    "name": "Wenyan",
    ...
    "import": () => import("./wenyan-XIJHZG5X.js")
  },
  {
    "id": "wgsl",
    "name": "WGSL",
    "import": () => import("./wgsl-DXUEQOFE.js")
  },
  {
    "id": "wikitext",
    "name": "Wikitext",
    ...
    "import": () => import("./wikitext-6L3KLC3M.js")
  },
  {
    "id": "wit",
    "name": "WebAssembly Interface Types",
    "import": () => import("./wit-UBKSOZGX.js")
  },
  {
    "id": "wolfram",
    "name": "Wolfram",
    ...
    "import": () => import("./wolfram-3XQ2OXNS.js")
  },
  {
    "id": "xml",
    "name": "XML",
    "import": () => import("./xml-CNG6SVBS.js")
  },
  {
    "id": "xsl",
    "name": "XSL",
    "import": () => import("./xsl-NW4Q6Q2J.js")
  },
  {
    "id": "yaml",
    "name": "YAML",
    ...
    "import": () => import("./yaml-KPLXRKFL.js")
  },
  {
    "id": "zenscript",
    "name": "ZenScript",
    "import": () => import("./zenscript-5MAWXPF4.js")
  },
  {
    "id": "zig",
    "name": "Zig",
    "import": () => import("./zig-V26ZTQ33.js")
  }
];
...
var bundledLanguagesAlias = Object.fromEntries(bundledLanguagesInfo.flatMap((i2) => {
  var _a4;
  return ((_a4 = i2.aliases) == null ? void 0 : _a4.map((a) => [a, i2.import])) || [];
}));
...
// node_modules/.pnpm/shiki@3.2.1/node_modules/shiki/dist/themes.mjs
var bundledThemesInfo = [
  {
    "id": "andromeeda",
    "displayName": "Andromeeda",
    "type": "dark",
    "import": () => import("./andromeeda-ICGKD7EB.js")
  },
  {
    "id": "aurora-x",
    "displayName": "Aurora X",
    "type": "dark",
    "import": () => import("./aurora-x-TYHWDLUY.js")
  },
  {
    "id": "ayu-dark",
    "displayName": "Ayu Dark",
    "type": "dark",
    "import": () => import("./ayu-dark-RAMYCJZD.js")
  },
  {
    "id": "catppuccin-frappe",
    "displayName": "Catppuccin Frappé",
    "type": "dark",
    "import": () => import("./catppuccin-frappe-4H6QTTYD.js")
  },
  {
    "id": "catppuccin-latte",
    "displayName": "Catppuccin Latte",
    "type": "light",
    "import": () => import("./catppuccin-latte-B4DKFG42.js")
  },
  {
    "id": "catppuccin-macchiato",
    "displayName": "Catppuccin Macchiato",
    "type": "dark",
    "import": () => import("./catppuccin-macchiato-J6XKSIP7.js")
  },
  {
    "id": "catppuccin-mocha",
    "displayName": "Catppuccin Mocha",
    "type": "dark",
    "import": () => import("./catppuccin-mocha-JMSZEXHE.js")
  },
  {
    "id": "dark-plus",
    "displayName": "Dark Plus",
    "type": "dark",
    "import": () => import("./dark-plus-QTVPGWZB.js")
  },
  {
    "id": "dracula",
    "displayName": "Dracula Theme",
    "type": "dark",
    "import": () => import("./dracula-KS5WVZUS.js")
  },
  {
    "id": "dracula-soft",
    "displayName": "Dracula Theme Soft",
    "type": "dark",
    "import": () => import("./dracula-soft-N5T3MJGJ.js")
  },
  {
    "id": "everforest-dark",
    "displayName": "Everforest Dark",
    "type": "dark",
    "import": () => import("./everforest-dark-5Z6SMSMH.js")
  },
  {
    "id": "everforest-light",
    "displayName": "Everforest Light",
    "type": "light",
    "import": () => import("./everforest-light-J7IHDQTQ.js")
  },
  {
    "id": "github-dark",
    "displayName": "GitHub Dark",
    "type": "dark",
    "import": () => import("./github-dark-TDSIDOXI.js")
  },
  {
    "id": "github-dark-default",
    "displayName": "GitHub Dark Default",
    "type": "dark",
    "import": () => import("./github-dark-default-UF4TDPOM.js")
  },
  {
    "id": "github-dark-dimmed",
    "displayName": "GitHub Dark Dimmed",
    "type": "dark",
    "import": () => import("./github-dark-dimmed-QQEQOF4T.js")
  },
  {
    "id": "github-dark-high-contrast",
    "displayName": "GitHub Dark High Contrast",
    "type": "dark",
    "import": () => import("./github-dark-high-contrast-NCLYJ2J3.js")
  },
  {
    "id": "github-light",
    "displayName": "GitHub Light",
    "type": "light",
    "import": () => import("./github-light-4T3J5EFC.js")
  },
  {
    "id": "github-light-default",
    "displayName": "GitHub Light Default",
    "type": "light",
    "import": () => import("./github-light-default-6Q5MJUPZ.js")
  },
  {
    "id": "github-light-high-contrast",
    "displayName": "GitHub Light High Contrast",
    "type": "light",
    "import": () => import("./github-light-high-contrast-GBRRQDDW.js")
  },
  {
    "id": "gruvbox-dark-hard",
    "displayName": "Gruvbox Dark Hard",
    "type": "dark",
    "import": () => import("./gruvbox-dark-hard-MIL6QM4K.js")
  },
  {
    "id": "gruvbox-dark-medium",
    "displayName": "Gruvbox Dark Medium",
    "type": "dark",
    "import": () => import("./gruvbox-dark-medium-PMEOMDYT.js")
  },
  {
    "id": "gruvbox-dark-soft",
    "displayName": "Gruvbox Dark Soft",
    "type": "dark",
    "import": () => import("./gruvbox-dark-soft-MPEC62TU.js")
  },
  {
    "id": "gruvbox-light-hard",
    "displayName": "Gruvbox Light Hard",
    "type": "light",
    "import": () => import("./gruvbox-light-hard-EPQ3YB4D.js")
  },
  {
    "id": "gruvbox-light-medium",
    "displayName": "Gruvbox Light Medium",
    "type": "light",
    "import": () => import("./gruvbox-light-medium-3SMBSGYT.js")
  },
  {
    "id": "gruvbox-light-soft",
    "displayName": "Gruvbox Light Soft",
    "type": "light",
    "import": () => import("./gruvbox-light-soft-GVALG5IE.js")
  },
  {
    "id": "houston",
    "displayName": "Houston",
    "type": "dark",
    "import": () => import("./houston-OANEHTHH.js")
  },
  {
    "id": "kanagawa-dragon",
    "displayName": "Kanagawa Dragon",
    "type": "dark",
    "import": () => import("./kanagawa-dragon-H6UUV3T6.js")
  },
  {
    "id": "kanagawa-lotus",
    "displayName": "Kanagawa Lotus",
    "type": "light",
    "import": () => import("./kanagawa-lotus-WF5AE5D6.js")
  },
  {
    "id": "kanagawa-wave",
    "displayName": "Kanagawa Wave",
    "type": "dark",
    "import": () => import("./kanagawa-wave-VOL5U7O5.js")
  },
  {
    "id": "laserwave",
    "displayName": "LaserWave",
    "type": "dark",
    "import": () => import("./laserwave-KWCBCLJK.js")
  },
  {
    "id": "light-plus",
    "displayName": "Light Plus",
    "type": "light",
    "import": () => import("./light-plus-33CHIHBZ.js")
  },
  {
    "id": "material-theme",
    "displayName": "Material Theme",
    "type": "dark",
    "import": () => import("./material-theme-D5BLO7C7.js")
  },
  {
    "id": "material-theme-darker",
    "displayName": "Material Theme Darker",
    "type": "dark",
    "import": () => import("./material-theme-darker-NEOR3AWE.js")
  },
  {
    "id": "material-theme-lighter",
    "displayName": "Material Theme Lighter",
    "type": "light",
    "import": () => import("./material-theme-lighter-UQ3N7S25.js")
  },
  {
    "id": "material-theme-ocean",
    "displayName": "Material Theme Ocean",
    "type": "dark",
    "import": () => import("./material-theme-ocean-O6NSDC3Q.js")
  },
  {
    "id": "material-theme-palenight",
    "displayName": "Material Theme Palenight",
    "type": "dark",
    "import": () => import("./material-theme-palenight-XLZSYYUO.js")
  },
  {
    "id": "min-dark",
    "displayName": "Min Dark",
    "type": "dark",
    "import": () => import("./min-dark-R7ALJRB2.js")
  },
  {
    "id": "min-light",
    "displayName": "Min Light",
    "type": "light",
    "import": () => import("./min-light-PHV4O3JT.js")
  },
  {
    "id": "monokai",
    "displayName": "Monokai",
    "type": "dark",
    "import": () => import("./monokai-6BKX2RNC.js")
  },
  {
    "id": "night-owl",
    "displayName": "Night Owl",
    "type": "dark",
    "import": () => import("./night-owl-T6UWFW23.js")
  },
  {
    "id": "nord",
    "displayName": "Nord",
    "type": "dark",
    "import": () => import("./nord-7HGPCEJ6.js")
  },
  {
    "id": "one-dark-pro",
    "displayName": "One Dark Pro",
    "type": "dark",
    "import": () => import("./one-dark-pro-NYRBIPKR.js")
  },
  {
    "id": "one-light",
    "displayName": "One Light",
    "type": "light",
    "import": () => import("./one-light-ZVGC2UAB.js")
  },
  {
    "id": "plastic",
    "displayName": "Plastic",
    "type": "dark",
    "import": () => import("./plastic-4TUM4GG4.js")
  },
  {
    "id": "poimandres",
    "displayName": "Poimandres",
    "type": "dark",
    "import": () => import("./poimandres-JYBNFQRK.js")
  },
  {
    "id": "red",
    "displayName": "Red",
    "type": "dark",
    "import": () => import("./red-DCF7MKNU.js")
  },
  {
    "id": "rose-pine",
    "displayName": "Rosé Pine",
    "type": "dark",
    "import": () => import("./rose-pine-ZFPEHGRC.js")
  },
  {
    "id": "rose-pine-dawn",
    "displayName": "Rosé Pine Dawn",
    "type": "light",
    "import": () => import("./rose-pine-dawn-PBTIJMSO.js")
  },
  {
    "id": "rose-pine-moon",
    "displayName": "Rosé Pine Moon",
    "type": "dark",
    "import": () => import("./rose-pine-moon-INZCECDD.js")
  },
  {
    "id": "slack-dark",
    "displayName": "Slack Dark",
    "type": "dark",
    "import": () => import("./slack-dark-35QWU36A.js")
  },
  {
    "id": "slack-ochin",
    "displayName": "Slack Ochin",
    "type": "light",
    "import": () => import("./slack-ochin-QKBIZ47X.js")
  },
  {
    "id": "snazzy-light",
    "displayName": "Snazzy Light",
    "type": "light",
    "import": () => import("./snazzy-light-VTTNAOOU.js")
  },
  {
    "id": "solarized-dark",
    "displayName": "Solarized Dark",
    "type": "dark",
    "import": () => import("./solarized-dark-7Y65KJHO.js")
  },
  {
    "id": "solarized-light",
    "displayName": "Solarized Light",
    "type": "light",
    "import": () => import("./solarized-light-MDL5ED5U.js")
  },
  {
    "id": "synthwave-84",
    "displayName": "Synthwave '84",
    "type": "dark",
    "import": () => import("./synthwave-84-243CTY7J.js")
  },
  {
    "id": "tokyo-night",
    "displayName": "Tokyo Night",
    "type": "dark",
    "import": () => import("./tokyo-night-GE35CBVC.js")
  },
  {
    "id": "vesper",
    "displayName": "Vesper",
    "type": "dark",
    "import": () => import("./vesper-XX54GCZS.js")
  },
  {
    "id": "vitesse-black",
    "displayName": "Vitesse Black",
    "type": "dark",
    "import": () => import("./vitesse-black-5Q5RHWGQ.js")
  },
  {
    "id": "vitesse-dark",
    "displayName": "Vitesse Dark",
    "type": "dark",
    "import": () => import("./vitesse-dark-5NIZ43WR.js")
  },
  {
    "id": "vitesse-light",
    "displayName": "Vitesse Light",
    "type": "light",
    "import": () => import("./vitesse-light-FSKVNPTD.js")
  }
];
var bundledThemes = Object.fromEntries(bundledThemesInfo.map((i2) => [i2.id, i2.import]));

// node_modules/.pnpm/@shikijs+engine-oniguruma@3.2.1/node_modules/@shikijs/engine-oniguruma/dist/index.mjs
...
// node_modules/.pnpm/shiki@3.2.1/node_modules/shiki/dist/bundle-full.mjs
var createHighlighter = createdBundledHighlighter({
  langs: bundledLanguages,
  themes: bundledThemes,
  engine: () => createOnigurumaEngine(import("./wasm-SNRZFQDM.js"))
});
var {
...
function P(e2, t = {}) {
  ...
  const i2 = z(n.flags), a = [i2.extended], p2 = { captureGroup: n.rules.captureGroup, getCurrentModX: () => a.at(-1), numOpenGroups: 0, popModX() {
    a.pop();
  }, pushModX(c2) {
    a.push(c2);
  ...
  for (k.lastIndex = 0; u = k.exec(e2); ) {
    const c2 = F(p2, e2, u[0], k.lastIndex);
...
function F(e2, t, n, i2) {
  ...
  if (a === "\\") {
    if ("AbBGyYzZ".includes(p2)) return { token: s2(o2.Assertion, n, { kind: n }) };
    if (/^\\g[<']/.test(n)) {
    ...
    if (p2 === "K") return { token: s2(o2.Directive, n, { kind: x.keep }) };
    if (p2 === "N" || p2 === "R") return { token: s2(o2.CharacterSet, n, { kind: h.newline, negate: p2 === "N" }) };
    if (p2 === "O") return { token: s2(o2.CharacterSet, n, { kind: h.any }) };
    if (p2 === "X") return { token: s2(o2.CharacterSet, n, { kind: h.grapheme }) };
...
function M(e2, t, n) {
  ...
  let a = 1, p2;
  for (A.lastIndex = n; p2 = A.exec(e2); ) {
    const r4 = p2[0];
...
function O(e2, { inCharClass: t }) {
  ...
  if (new RegExp("^\\\\x[89A-Fa-f]\\p{AHex}", "u").test(e2)) try {
    const i2 = e2.split(/\\x/).slice(1).map((u) => parseInt(u, 16)), a = new TextDecoder("utf-8", { ignoreBOM: true, fatal: true }).decode(new Uint8Array(i2)), p2 = new TextEncoder();
    return [...a].map((u) => {
      const l = [...p2.encode(u)].map((f2) => `\\x${f2.toString(16)}`).join("");
...
function W(e2, t) {
  ...
  i2 ?? (i2 = "");
  const a = (t.getCurrentModX() || n.includes("x")) && !i2.includes("x"), p2 = b(n), r4 = b(i2), u = {};
  if (p2 && (u.enable = p2), r4 && (u.disable = r4), e2.endsWith(")")) return t.replaceCurrentModX(a), s2(o2.Directive, e2, { kind: x.flags, flags: u });
  if (e2.endsWith(":")) {
    t.pushModX(a), t.numOpenGroups++;
    const l = s2(o2.GroupOpen, e2, { kind: g.group });
    return (p2 || r4) && (l.flags = u), l;
  }
...
function N(e2) {
  if (new RegExp("^(?:\\\\u(?!\\p{AHex}{4})|\\\\x(?!\\p{AHex}{1,2}|\\{\\p{AHex}{1,8}\\}))", "u").test(e2)) throw new Error(`Incomplete or invalid escape "${e2}"`);
  const t = e2[2] === "{" ? new RegExp("^\\\\x\\{\\s*(?<hex>\\p{AHex}+)", "u").exec(e2).groups.hex : e2.slice(2);
  return parseInt(t, 16);
}
function j(e2, t) {
  const { raw: n, inCharClass: i2 } = e2, a = n.slice(1);
  if (!i2 && (a !== "0" && a.length === 1 || a[0] !== "0" && +a <= t)) return [s2(o2.Backreference, n)];
  const p2 = [], r4 = a.match(/^[0-7]+|\d/g);
  for (let u = 0; u < r4.length; u++) {
    ...
    p2.push(s2(o2.Character, (u === 0 ? "\\" : "") + l, { value: f2 }));
  }
  return p2;
}
function v(e2) {
...
function ne(e2, r4 = {}) {
  ...
  function o3(p2, m) {
    ...
    switch (t.parent = p2, t.token = d, t.current++, d.type) {
      case o2.Alternator:
        return k2();
      case o2.Assertion:
        return le(d);
  ...
  for (; t.current < a.tokens.length; ) {
    const p2 = o3(c2, {});
    p2.type === s3.Alternative ? (i2.pattern.alternatives.push(p2), c2 = p2) : c2.elements.push(p2);
  }
  ...
  for (const { ref: p2 } of N2) if (typeof p2 == "number") {
    if (p2 > u.length) throw new Error("Subroutine uses a group number that's not defined");
  } else if (y2.has(p2)) {
    if (y2.get(p2).length > 1) throw new Error(o`Subroutine uses a duplicate group name "\g<${p2}>"`);
...
function se({ token: e2, normalizeUnknownPropertyNames: r4, skipPropertyNameValidation: n, unicodePropertyMap: a }) {
  ...
  if (t === h.property) {
    const c2 = $2(i2);
    if (i.has(c2) && !(a == null ? void 0 : a.has(c2))) t = h.posix, i2 = c2;
...
function ie(e2, r4) {
  ...
  let p2 = W2(a[e2.current]);
  for (; p2.type !== o2.GroupClose; ) {
    if (p2.type === o2.Alternator) u.alternatives.push(k2()), e2.current++;
    else {
...
function V(e2, r4) {
  ...
  return (e2 === f.word_boundary || e2 === f.grapheme_boundary) && (n.negate = !!(r4 == null ? void 0 : r4.negate)), n;
}
function le({ kind: e2 }) {
...
function T(e2, r4) {
  const n = !!(r4 == null ? void 0 : r4.negate), a = { type: s3.CharacterSet, kind: c(A2[e2], `Unexpected character set kind "${e2}"`) };
...
function S(e2) {
  const r4 = e2 == null ? void 0 : e2.atomic, n = e2 == null ? void 0 : e2.flags;
...
function Y(e2, r4) {
  ...
  let a = (_a4 = n.unicodePropertyMap) == null ? void 0 : _a4.get($2(e2));
  if (!a) {
...
function J(e2, r4) {
  return c(e2, `${(r4 == null ? void 0 : r4.value) === 93 ? "Empty" : "Unclosed"} character class`);
}
function W2(e2) {
...
function T2(A3, C2, p2 = null) {
  ...
  function l(e2, i2 = null, r4 = null, a = null) {
    ...
    const u = { node: e2, parent: i2, key: r4, container: a, root: A3, remove() {
      ...
      n = true;
    } }, h2 = C2["*"], m = C2[e2.type], k3 = typeof h2 == "function" ? h2 : h2 == null ? void 0 : h2.enter, M3 = typeof m == "function" ? m : m == null ? void 0 : m.enter;
    if (k3 == null ? void 0 : k3(u, p2), M3 == null ? void 0 : M3(u, p2), !n) switch (e2.type) {
      case s3.Regex:
    ...
    return (_a4 = h2 == null ? void 0 : h2.exit) == null ? void 0 : _a4.call(h2, u, p2), (_b = m == null ? void 0 : m.exit) == null ? void 0 : _b.call(m, u, p2), c2;
  }
  l(A3);
}
...
// node_modules/.pnpm/oniguruma-to-es@4.1.0/node_modules/oniguruma-to-es/dist/esm/index.js
...
White_Space space
XID_Continue XIDC
XID_Start XIDS`.split(/\s/).map((p2) => [$2(p2), p2])
);
...
var FirstPassVisitor = {
  ...
  Alternative: {
    enter({ node, parent, key: key2 }, { flagDirectivesByAlt }) {
      ...
      for (let i2 = key2 + 1; i2 < parent.alternatives.length; i2++) {
  ...
  Directive({ node, parent, root: root2, remove, replaceWith, removeAllPrevSiblings, removeAllNextSiblings }) {
    ...
    if (kind === E2.flags) {
      ...
      const firstAltFirstEl = root2.pattern.alternatives[0].elements[0];
      const hasWrapperGroup = (
        // Not emulatable if within a `CapturingGroup`
        hasOnlyChild(root2.pattern, (kid) => kid.type === s3.Group) && firstAltFirstEl.alternatives.length === 1
      );
      const topLevel = hasWrapperGroup ? firstAltFirstEl : root2.pattern;
...
function cloneCapturingGroup(obj, originMap, up, up2) {
  ...
  for (const [key2, value] of Object.entries(obj)) {
    if (key2 === "parent") {
      ...
      if (key2 === "type" && value === s3.CapturingGroup) {
...
function genCapturingGroup(node, state, gen) {
  const { name, number: number2, alternatives } = node;
...
// node_modules/.pnpm/@shikijs+engine-javascript@3.2.1/node_modules/@shikijs/engine-javascript/dist/shared/engine-javascript.hzpS1_41.mjs
var MAX = 4294967295;
  ...
  constructor(patterns, options = {}) {
    ...
    this.regexps = patterns.map((p2) => {
      ...
      try {
        ...
        cache == null ? void 0 : cache.set(p2, e2);
        if (forgiving)
          return null;
        throw e2;
      }
...
// node_modules/.pnpm/@shikijs+engine-javascript@3.2.1/node_modules/@shikijs/engine-javascript/dist/engine-compile.mjs
